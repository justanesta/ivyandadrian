  ...
  return (
    <main className="container py-5" style={{ maxWidth: 900 }}>
      ...
      <div className="d-grid gap-4">
        {/* Transportation */}
        <section className="border rounded border-forest p-3 bg-sky">
          ...
          <p className="mb-0">
            ...
            You can indicate whether you plan to use the bus on the <strong><Link href="/rsvp" className="text-forest">RSVP page</Link></strong>.
          </p>
        </section>
        ...
        <section className="border rounded border-forest p-3 bg-sky">
          ...
          <p className="mb-0">
            Yes. Please note any allergies or dietary needs on the <strong><Link href="/rsvp" className="text-forest">RSVP page</Link></strong> and we’ll pass them along to the caterer.
          </p>
        </section>
        ...
        <section className="border rounded border-forest p-3 bg-sky">
          ...
          <p className="mb-0">
            You’ll find gift ideas, a home fund and a vacation fund on our <strong><Link href="/registry" className="text-forest">Registry</Link></strong> page.
          </p>
        </section>
        ...
        <section className="border rounded border-forest p-3 bg-sky">
          ...
          <p className="mb-0">
            If you provide an email on the <strong><Link href="/rsvp" className="text-forest">RSVP page</Link></strong>, we’ll share any important updates over email.
          </p>
        </section>
      </div>
    </main>
